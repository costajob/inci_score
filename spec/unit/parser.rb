...
describe InciScore::Parser do
  ...
  it 'must collect component data properly' do
    parser.call.must_equal({"phosphatidylcholine"=>1, "1-naphthol"=>4, "1,2,4-benzenetriacetate"=>3, "1,3-bis-(2,4-diaminophenoxy)propane"=>0, "acetylated lanolin"=>2, "hexyldecyl laurate"=>2})
  end
end
